<header>
    <div class="container">
        <div class="header-content d-flex flex-wrap align-items-center">
            ...
            <div class="logo">
                <a href="/main/" title>
                    <img src="/resources/images/png/logo.png" alt>
                </a>
            </div><!-- logo end-->
            <nav>
                <ul>
            ...
            <ul class="contact-head-info ml-auto">
                <li>
                    <img src="/resources/fonts/phone.svg" alt>
                    <span>+44 62 7146 9812</span>
                </li>
                <li>
                    <img src="/resources/fonts/mail.svg" alt>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="menu-widget">
                            ...
                            <ul>
                                <li><a href="/about/" title>About Us</a></li>
                                <li><a href="/team/" title>Our Team</a></li>
                    ...
                    <div class="col-md-4">
                        <div class="menu-widget">
                            <h4>Services</h4>
                            <ul>
                                <li><a href="/services/" title>Judicial protection</a></li>
                                <li><a href="/services/" title>Lawyer consulting</a></li>
                                <li><a href="/services/" title>Debt collection</a></li>
                                <li><a href="/services/" title>Protection of rights</a></li>
                                <li><a href="/services/" title>Real estate lawyer</a></li>
                            </ul>
                        </div><!--menu-widget end-->
                    </div>
                </div>
